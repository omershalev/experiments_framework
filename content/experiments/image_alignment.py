...
class ImageAlignmentExperiment(Experiment):
    ...
    def task(self, **kwargs):
        ...
        _, baseline_canopies_mask = segmentation.extract_canopy_contours(baseline_image)
        ...
        _, warped_canopies_mask_by_markers = segmentation.extract_canopy_contours(warped_image_by_markers)
        mse = cv_utils.calculate_image_similarity(baseline_canopies_mask, warped_canopies_mask_by_markers, method='mse')
        ssim = cv_utils.calculate_image_similarity(baseline_canopies_mask, warped_canopies_mask_by_markers, method='ssim')
        ...
        _, warped_canopies_mask_by_orb = segmentation.extract_canopy_contours(warped_image_by_orb)
        mse = cv_utils.calculate_image_similarity(baseline_canopies_mask, warped_canopies_mask_by_orb, method='mse')
        ssim = cv_utils.calculate_image_similarity(baseline_canopies_mask, warped_canopies_mask_by_orb, method='ssim')
        ...
        _, warped_canopies_mask_by_trunks = segmentation.extract_canopy_contours(warped_image_by_trunks)
        mse = cv_utils.calculate_image_similarity(baseline_canopies_mask, warped_canopies_mask_by_trunks, method='mse')
        ssim = cv_utils.calculate_image_similarity(baseline_canopies_mask, warped_canopies_mask_by_trunks, method='ssim')
