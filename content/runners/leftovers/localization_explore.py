...
if __name__ == '__main__':
    ...
    range, coordinates_list = contours_scan2.generate(map_image, center_x=x, center_y=y, min_angle=0, max_angle=2 * np.pi, samples_num=360, min_distance=3, max_distance=300, resolution=config.top_view_resolution) # TODO: resolution
